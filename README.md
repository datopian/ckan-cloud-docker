...
```
docker-compose -f docker-compose.yaml -f .docker-compose-db.yaml -f .docker-compose.honduras-theme.yaml down -v
```
...
```
docker-compose -f docker-compose.yaml -f .docker-compose-db.yaml -f .docker-compose.honduras-theme.yaml up -d nginx
```
...
For example, to start the honduras-theme configuration:

```
docker-compose -f docker-compose.yaml -f .docker-compose-db.yaml -f .docker-compose.honduras-theme.yaml up -d --build nginx
```
